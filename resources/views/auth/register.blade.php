        ...
        <div class="row">
          <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
            <div class="login-brand">
              <span class="text-success">JURAGAN</span> KOS
            </div>
              ...
              <div class="card-body">
                <form method="POST" action="{{route('register')}}">
                  ...
                  <div class="form-group">
                    <label for="mendafatar">Mendaftar Sebagai</label>
                    <select name="roles" id="roles" class="form-control" required>
                        <option value="0" disabled>--Pilih Akses--</option>
                        <option value="pemilik">Pemilik Kos</option>
                        <option value="member">Pencari Kos</option>
                    </select>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-6">
                      <label for="no_hp" class="d-block">Handphone</label>
